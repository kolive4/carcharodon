...
plot_covars = function(cfg, bathy = NULL, log_bathy = NULL, fish = NULL, dfs = NULL, covars = NULL, obs = NULL, plot_points = NULL, contour = NULL, plot_contour = NULL){
  ...
  if ("MLD" %in% cfg$covars){
    ...
    # print(mld_points)
    # dev.off()
    ggsave(filename = sprintf("%s_mld_points.png", cfg$version), 
    #need to find a way to separate when making multiple, can I paste in a value from the cfg that would be an identifier?
           plot = mld_points, 
           path = file.path(vpath, "figures"), 
           width = 11, height = 8.5, units = "in", dpi = 300,
           create.dir = TRUE)
  ...
  if ("SSS" %in% cfg$covars){
    ...
    ggsave(filename = sprintf("%s_sss_points.png", cfg$version),
           plot = sss_points, 
           path = file.path(vpath, "figures"), 
           width = 11, height = 8.5, units = "in", dpi = 300,
           create.dir = TRUE)
  ...
  if ("Sbtm" %in% cfg$covars){
    ...
    # print(sbtm_points)
    # dev.off()
    ggsave(filename = sprintf("%s_sbtm_points.png", cfg$version), 
           plot = sbtm_points, 
           path = file.path(vpath, "figures"), 
           width = 11, height = 8.5, units = "in", dpi = 300,
           create.dir = TRUE)
  ...
  if ("U" %in% cfg$covars){
    ...
    # print(u_points)
    # dev.off()
    ggsave(filename = sprintf("%s_u_points.png", cfg$version),
           plot = u_points, 
           path = file.path(vpath, "figures"), 
           width = 11, height = 8.5, units = "in", dpi = 300,
           create.dir = TRUE)
  ...
  if ("V" %in% cfg$covars){
    ...
    # print(v_points)
    # dev.off()
    ggsave(filename = sprintf("%s_v_points.png", cfg$version), 
           plot = v_points, 
           path = file.path(vpath, "figures"), 
           width = 11, height = 8.5, units = "in", dpi = 300,
           create.dir = TRUE)
  ...
  if ("Xbtm" %in% cfg$covars){
    ...
    # print(xbtm_points)
    # dev.off()
    ggsave(filename = sprintf("%s_xbtm_points.png", cfg$version), 
           plot = xbtm_points, 
           path = file.path(vpath, "figures"), 
           width = 11, height = 8.5, units = "in", dpi = 300,
           create.dir = TRUE)
