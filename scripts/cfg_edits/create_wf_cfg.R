...
copy_amend_wf_cfg = function(wf_version,
  ...
  cov_map <- list(
    ...
    "07" = list(dynamic_names = c("brick_sst", "brick_tbtm", "brick_sbtm", "gseal", "hseal"),
                static_names = "log_depth"),
    "09" = list(dynamic_names = c("brick_sst", "gseal", "hseal"),
                static_names = c("log_depth", "month")),
    "11" = list(dynamic_names = c("brick_sst"),
                static_names = c("log_depth", "month")),
    "12" = list(dynamic_names = c("brick_sst", "gseal"),
                static_names = c("log_depth", "month")),
    "13" = list(dynamic_names = c("brick_sst", "hseal"),
                static_names = c("log_depth", "month"))
  )
