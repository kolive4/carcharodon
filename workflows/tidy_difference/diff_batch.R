...
script = "/mnt/ecocast/projects/koliveira/subprojects/carcharodon/workflows/tidy_difference/difference.R"

charlier::start_logger(filename = file.path("/mnt/ecocast/projects/koliveira/subprojects/carcharodon/workflows/tidy_difference/log"))
for (yaml in yamls) {
...
charlier::sendmail("koliveira@bigelow.org", message = "Differences complete.")