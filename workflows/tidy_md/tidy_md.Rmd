...
# r
```
`r cat("Absolute path: ", rf_now$abs, "\n")`
`r cat("Relative path: ", rf_now$rel, "\n")`
`r embed_fig(list(rf_now, rf_fore))`
...
bt_fore = fig_path(root = cfg$root_path,
                   ...
                   model_type = "bt")
```
`r embed_fig(list(bt_now, bt_fore))`
...
maxent_fore = fig_path(root = cfg$root_path,
                   ...
                   model_type = "maxent")
```
`r embed_fig(list(maxent_now, maxent_fore))`
...
gam_fore = fig_path(root = cfg$root_path,
                   ...
                   model_type = "gam")
```
`r embed_fig(list(gam_now, gam_fore))`
...
glm_fore = fig_path(root = cfg$root_path,
                   ...
                   model_type = "glm")
```
`r embed_fig(list(glm_now, glm_fore))`
