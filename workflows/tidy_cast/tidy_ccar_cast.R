...
args = argparser::arg_parser("tidymodels/tidysdm casting for white shark habitat suitability",
                             name = "tidy_ccar_cast.R",
                             hide.opts = TRUE) |>
  argparser::add_argument(arg = "--config",
                          type = "character",
                          default = "/mnt/s1/projects/ecocast/projects/koliveira/subprojects/carcharodon/workflows/tidy_cast/t41.100960.08.yaml",
